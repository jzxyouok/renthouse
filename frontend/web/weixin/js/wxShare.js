	...
	function wxShare(conf_outer){
			var conf_inner =  {
				...
				"title" : '易租房 - 精准租房平台！',
				"desc" : '我要租房，快来约我！',
				"link" : 'http://www.lovespace.cc/weixin/index.html',
				"imgUrl" :'http://www.lovespace.cc/assets/frontend/images/logo-common.jpg'
			}
			...
			function ajax_get_jssdk_conf(options) {
				console.log('wxShare.js:ajax_get_jssdk_conf  '+JSON.stringify(options));
				console.log('ajax_get_jssdk_conf getJssdkConfUrl:'+conf.getJssdkConfUrl);
				jQuery.ajax({
					url: "http://www.lovespace.cc/?r=door/get-jssdk&url="+conf.getJssdkConfUrl,
